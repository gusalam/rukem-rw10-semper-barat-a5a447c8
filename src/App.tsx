...
import RingkasanKKPage from "./pages/admin/RingkasanKKPage";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin/ringkasan-kk" element={<ProtectedRoute requiredRole="admin"><RingkasanKKPage /></ProtectedRoute>} />
